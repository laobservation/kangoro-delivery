...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    fragileItem: 'Fragile Item (+20 MAD)',
    fragileDesc: 'Secured in cushioned front compartment',
    declaredValue: 'Declared Value (MAD)',
    ...
    doorstepPickupOption: 'Origin Doorstep Pickup (+25 MAD)',
    doorstepPickupDesc: 'Driver picks up parcel at your doorstep',
    doorstepDropoffOption: 'Destination Doorstep Dropoff (+25 MAD)',
    ...
    driverFlatBaseRate: 'Base Rate per Parcel (MAD) *',
    driverKgRate: 'Rate per extra Kg (MAD) *',
    driverDoorstepToggle: 'Accept Doorstep Pickup & Delivery',
    driverDoorstepToggleSub: 'Charge extra +25 MAD for city-center door pickups',
  ...
  fr: {
    ...
    fragileItem: 'Objet Fragile (+20 MAD)',
    fragileDesc: 'Placé en sécurité dans le compartiment avant',
    declaredValue: 'Valeur Déclarée (MAD)',
    ...
    doorstepPickupOption: 'Ramassage à Domicile (+25 MAD)',
    doorstepPickupDesc: 'Le chauffeur récupère le colis à votre porte',
    doorstepDropoffOption: 'Livraison à Domicile (+25 MAD)',
    ...
    driverFlatBaseRate: 'Tarif Forfaitaire par Colis (MAD) *',
    driverKgRate: 'Supplément par Kg supplémentaire (MAD) *',
    driverDoorstepToggle: 'Accepter le Service Porte-à-Porte',
    driverDoorstepToggleSub: 'Facturez +25 MAD de plus pour les remises en centre-ville',
